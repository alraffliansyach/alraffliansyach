...
/**
Kocok array untuk setiap kolom
*/
...
/**
Tampilkan angka pada board

Awalnya pake looping terus
pake matriks
*/
Sudoku.prototype.boardGenerator = function(n, fixCellsNr) {
    ...
    //generate solusi untuk sudoku * masih kurang paham aku juga dapet dari internet
    this.boardSolution = [];
  
    //Pake matriks dilooping 
    for (i = 0; i < this.nn; i++) {
        matrix_fields[i] = i+1;
    }  
    
    //ngubah warna untuk kolom yang ada angka
    ...
    //kocok index dan hapus cell yang kosong
...
/**
Gambar sudoku di tampilan skrip html ada disini
*/
Sudoku.prototype.drawBoard = function(){
    ...
    //menggambar papan ketik untuk ngisi
    ...
    //tambah semua yang digambar ke tampilan
...
/**
milih kolom terus nampilin konsol
*/
